    ...
    public class BasketMockService : IBasketService
    {
        private CustomerBasket MockCustomBasket = new CustomerBasket
        {
            ...
            Items = new List<BasketItem>
                {
				new BasketItem { Id = "1", PictureUrl = Device.RuntimePlatform != "Windows" ? "fake_product_01.png" : "Assets/fake_product_01.png", ProductId = Common.Common.MockCatalogItemId01, ProductName = ".NET Bot Blue Sweatshirt (M)", Quantity = 1, UnitPrice = 19.50M },
				new BasketItem { Id = "2", PictureUrl = Device.RuntimePlatform != "Windows" ? "fake_product_04.png" : "Assets/fake_product_04.png", ProductId = Common.Common.MockCatalogItemId04, ProductName = ".NET Black Cupt", Quantity = 1, UnitPrice = 17.00M }
                }
        };
